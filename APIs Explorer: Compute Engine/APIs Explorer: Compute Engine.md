...
## Solution [here](https://youtu.be/TC2HvjQ3TOo)
...
```
curl -LO raw.githubusercontent.com/Techbarsha/github_cloud/refs/heads/main/APIs%20Explorer%3A%20Compute%20Engine/gsp293.sh
sudo chmod +x *.sh
