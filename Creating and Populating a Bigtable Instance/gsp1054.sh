...
while [ "$deploy_success" = false ]; do
  if deploy_function; then
    echo "Function deployed successfully. (https://www.youtube.com/@edutechbarsha)"
    deploy_success=true
  else
    echo "Deployment Retrying, please subscribe to Edutech Barsha (https://www.youtube.com/@edutechbarsha).."
    sleep 10
  fi
done
