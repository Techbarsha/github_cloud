...
exports.GCFunction = (req, res) => {
    let message = req.query.message || req.body.message || 'Subscribe to edutechbarsha';
...
DATA=$(printf 'Subscribe to edutech barsha' | base64) && gcloud functions call GCFunction --region=$REGION --data '{"data":"'$DATA'"}'
