...
# Start of the script
echo
echo "${BRIGHT_CYAN_TEXT}${BOLD_TEXT}Starting the Execution!!${RESET_FORMAT}"
echo
...
echo -e "${BRIGHT_RED_TEXT}${BOLD_TEXT}Subscribe our Channel:${RESET_FORMAT} ${BLUE_TEXT}${BOLD_TEXT}https://www.youtube.com/@edutechbarsha${RESET_FORMAT}"
echo
