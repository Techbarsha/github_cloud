...
echo "${MAGENTA}${BOLD}Click here: "${RESET}""${BLUE}${BOLD}""https://console.cloud.google.com/logs/query?"""${RESET}"

echo "${RED}${BOLD}NOW${RESET}" "${WHITE}${BOLD}FOLLOW${RESET}" "${GREEN}${BOLD}VIDEO'S INSTRUCTIONS${RESET}"
